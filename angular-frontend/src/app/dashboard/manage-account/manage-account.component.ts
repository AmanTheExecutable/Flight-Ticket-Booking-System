...
export class ManageAccountComponent implements OnInit {
  ...
  constructor(private bookingService: BookingService, private userService: UserService, private fb: FormBuilder) { }
  ...
  saveChanges(): void {
    if (this.userForm.valid) {
      const confirmUpdate = window.confirm('Are you sure you want to update the details?');
      if (confirmUpdate) {
